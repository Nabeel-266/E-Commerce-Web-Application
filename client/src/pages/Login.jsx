...
const Login = () => {
  ...
  return (
    <div className="w-full min-h-dvh pt-[6.6rem]">
      <div
        className="w-full h-[calc(100dvh-6.6rem)] bg-cover bg-no-repeat flex flex-col items-center justify-center"
        style={{
          backgroundImage: `url(${BackgroundImage})`,
          backgroundPosition: "center -14rem",
        }}
      >
        {/* Login Form Cont */}
        <div className="bg-transparent flex flex-col items-center justify-center p-[2rem] mb-[5rem] rounded-2xl">
          ...
          >
            ...
            <div className="flex items-center justify-between mt-[0.8rem]">
              <p className="text-[1.45rem] font-medium text-darker">
                Forgot Password?
              </p>
